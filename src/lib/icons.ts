 ...
 * ✅ OTIMIZAÇÃO CRÍTICA: Imports individuais reduzem bundle de 1.1 MB para ~50-100 KB
 * Import from here instead of 'lucide-react' directly to reduce bundle size
 */

// Critical icons (above-the-fold, used in Index/Hero/Header)
// ✅ OTIMIZAÇÃO: Imports individuais para tree-shaking eficiente
...
// Common icons (used in multiple components)
...
export { default as FileQuestion } from 'lucide-react/dist/esm/icons/file-question';
...
export { default as Scroll } from 'lucide-react/dist/esm/icons/scroll';
