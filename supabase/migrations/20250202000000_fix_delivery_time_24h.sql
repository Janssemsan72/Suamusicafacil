-- ==========================================
-- CORREÇÃO: Delivery time para 24h no plano Express
-- Ajusta função SQL para garantir que express retorne 24h
-- ==========================================

-- Atualizar função get_order_paid_variables para garantir 24h no express
...
BEGIN
  ...
  -- ✅ CORRIGIDO: Definir prazo conforme plano - Express é 22 horas (conforme solicitado)
...
'Extrai variáveis para template order_paid. Express plan retorna delivery_time: 24h (não 48h)';
