-- ==========================================
-- Correção: Trigger Auto Mark Cakto Paid - Validação de Transaction ID
-- ==========================================
...
BEGIN
  ...
  IF (NEW.provider = 'cakto' OR NEW.payment_provider = 'cakto') THEN
    ...
    -- Isso garante que só marca quando recebe confirmação real do provedor
...
'Função do trigger que marca automaticamente pedidos Cakto como pagos quando cakto_payment_status muda para approved/paid/pago E tem cakto_transaction_id válido. Garante que pedidos só sejam marcados como pagos quando realmente pagos.';
