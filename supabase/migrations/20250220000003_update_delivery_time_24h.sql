-- ==========================================
-- ATUALIZAR DELIVERY TIME PARA 24 HORAS NO PLANO EXPRESS
-- Corrige a função get_order_paid_variables para retornar 24 horas
-- ==========================================

-- Atualizar função get_order_paid_variables para retornar 24 horas no express
...
BEGIN
  ...
  -- ✅ CORRIGIDO: Express é 24 horas (conforme solicitado)
...
'Extrai variáveis para template order_paid. Express plan retorna delivery_time: 24 horas (pt), 24 horas (es), 24 hours (en). Standard plan retorna: 7 dias (pt), 7 días (es), 7 days (en)';
