-- ==========================================
-- Criar Função RPC para Marcar Funil de Email como Pago
-- ==========================================
-- Similar a mark_funnel_and_order_as_paid, mas para email funnels
...
'Marca ordem como paga e move funil de email para completed simultaneamente. Sempre atualiza paid_at e updated_at, mesmo se pedido já estiver como paid.';
