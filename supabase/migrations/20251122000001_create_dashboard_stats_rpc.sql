-- ==========================================
-- Função RPC para calcular estatísticas do dashboard admin
-- ==========================================
-- Esta função calcula todas as estatísticas necessárias usando SQL agregado
-- ao invés de buscar todos os pedidos e processar no frontend
-- ==========================================
