-- ==========================================
-- Trigger Automático: Marcar Pedidos Cakto como Pago
-- ==========================================
-- Este trigger marca automaticamente pedidos como 'paid' quando
-- cakto_payment_status muda para 'approved'/'paid'/'pago'
-- ==========================================
...
-- Criar trigger BEFORE UPDATE para interceptar antes da atualização
